...
# Set local variables
in_features = os.path.join(directory, r"Land_Use_and_Land_Cover_(2011).shp")
clip_features = os.path.join(directory, r"SK_selected.shp")
out_feature_class = os.path.join(directory, r"SK_landcover.shp")
# Execute Clip
arcpy.Clip_analysis(in_features, clip_features, out_feature_class)

# Select residential land cover from land cover dataset
# Set local variables
in_features = os.path.join(directory, r"SK_landcover.shp")
out_feature_class = os.path.join(directory, r"SK_residential.shp")
where_clause = '"Descr_2011" = \'High Density Residential (<1/8 acre lots)\''
# Execute Select
arcpy.Select_analysis(in_features, out_feature_class, where_clause)

# Buffer residential land cover by 500 yards
in_features = os.path.join(directory, r"SK_residential.shp")
out_feature_class = os.path.join(directory, r"SK_residential_buffer.shp")
