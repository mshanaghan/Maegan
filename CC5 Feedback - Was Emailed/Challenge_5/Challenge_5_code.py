...
# Set workspace
arcpy.env.workspace = "C:\Data\Students_2022\Shanaghan\CC5 Feedback - Was Emailed\Challenge_5"
input_directory = "C:\Data\Students_2022\Shanaghan\CC5 Feedback - Was Emailed\Challenge_5"
...
for species in species_list:
    ...
    arcpy.CopyFeatures_management(selection, "Species_" + str(species) + ".shp")
    # # # Extract the Extent, i.e. XMin, XMax, YMin, YMax
    desc = arcpy.Describe("Species_" + str(species) + ".shp")
